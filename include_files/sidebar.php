            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="social-media">
                        <ul class="nav">
                            <li class="twitter_account"> <a href="https://twitter.com/crndolo" target="_blank"> <i class="fa fa-twitter"> </i> </a> </li>
                            <!--<li> <a href="#" target="_blank"> <i class="fa fa-facebook"> </i> </a> </li>
                            <li> <a href="#" target="_blank"> <i class="fa fa-instagram"> </i> </a> </li>-->
                            <li class="youtube_account"> <a href="https://www.youtube.com/channel/UCm8TMlKvLg5m8SPuisQDOOg?disable_polymer=true" target="_blank"> <i class="fa fa-youtube"> </i> </a> </li>	
                            <li class="github_account"> <a href="https://github.com/ndolocr" target="_blank"> <i class="fa fa-github"> </i> </a> </li>
                        </ul>
                    </div>
                </div>
                <!-- End of col-md-12 -->
